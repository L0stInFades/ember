...
`logs/github-p1-trace-audit-28330936655` reports the 14-test /
61,346-retired / 20-trap / 5-AMO / 9-PTE-update / 21-privilege-switch baseline
with all 38 coverage-floor checks passing.
