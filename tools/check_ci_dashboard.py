...
def main():
    ...
    ap.add_argument("--min-rvtrace-tests", type=int, default=11)
    ap.add_argument("--min-rvtrace-retired", type=int, default=39000)
    ap.add_argument("--min-rvtrace-traps", type=int, default=12)
    ap.add_argument("--min-rvtrace-amos", type=int, default=5)
    ap.add_argument("--min-rvtrace-pte-updates", type=int, default=5)
    ap.add_argument("--min-rvtrace-priv-switches", type=int, default=15)
    ap.add_argument("--min-rvtrace-floor-checks", type=int, default=27)
