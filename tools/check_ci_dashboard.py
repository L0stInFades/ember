...
def main():
    ...
    ap.add_argument("--min-rvtrace-tests", type=int, default=16)
    ap.add_argument("--min-rvtrace-retired", type=int, default=70000)
    ap.add_argument("--min-rvtrace-traps", type=int, default=25)
    ...
    ap.add_argument("--min-rvtrace-floor-checks", type=int, default=46)
