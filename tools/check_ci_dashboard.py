...
def main():
    ...
    ap.add_argument("--min-rvtrace-tests", type=int, default=13)
    ap.add_argument("--min-rvtrace-retired", type=int, default=50000)
    ap.add_argument("--min-rvtrace-traps", type=int, default=17)
    ap.add_argument("--min-rvtrace-amos", type=int, default=5)
    ap.add_argument("--min-rvtrace-pte-updates", type=int, default=9)
    ap.add_argument("--min-rvtrace-priv-switches", type=int, default=19)
    ap.add_argument("--min-rvtrace-floor-checks", type=int, default=35)
